...
from example_original import data_pb2
from example_original import data_pb2_grpc
import numpy as np
...
opera.log_format('original_logs.log')
...
class FormatData(data_pb2_grpc.FormatDataServicer):
    def DoFormat(self, request, context):
        ...
        index_code = 'original'+':'+times.strftime("%Y%m%d", times.localtime())+':'+index_code
        time = request.time
        price = request.price
